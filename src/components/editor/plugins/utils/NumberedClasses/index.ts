...
const NumberedClasses = (editor: Editor) => {
  const baseComponents = ['block', 'container', 'rows', 'columns', 'grid',
    // 'heading-one', 'heading-two', 'heading-three', 'heading-four', 'heading-five', 'heading-six', 'paragraph', 'link', 'link-box', 'button', 'image', 'svg', 'video', 'material-icon', 'ordered-list', 'unordered-list', 'list-item', 'custom-code'
  ];

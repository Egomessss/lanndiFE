...
const pricings = (editor: Editor) => {
  ...
  const script = function() {
    ...
    const originalPrices = {
      basic: pricingElements.basic.textContent,
      professional: pricingElements.professional.textContent,
      master: pricingElements.master.textContent,
    };
    ...
    checkbox.addEventListener('click', () => {
      for (let key in pricingElements) {
        pricingElements[key].textContent = pricingElements[key].textContent === originalPrices[key]

...
import { ActionIcon, NumberInput, SegmentedControl, Select, Slider, TextInput, ThemeIcon } from '@mantine/core'
import { useEditor } from '../wrappers'
import React, { useState } from 'react'
import { IconArrowDown, IconArrowsUpDown, IconArrowUp, IconPlus, IconScaleOutline, IconX } from '@tabler/icons-react'

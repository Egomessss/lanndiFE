export const starter = `<body id='iau9'>
<div class='gjs-grid-row' id='i6po'>
  <div class='gjs-grid-column' id='itjq'>
    <div class='gjs-grid-row' id='iyd2'>
      <div class='gjs-grid-column' id='iqjl'><a class='gjs-link-box' id='iucmr' href='/public'>
          <div class='gjs-icon' data-type-icon='' id='irfl3k'><svg viewBox='0 0 202 40' fill='none'>
      ...
      <div class='gjs-grid-column' id='iffs'>
        <div class='gjs-grid-row' id='it00l'>
          <div class='gjs-grid-column' id='irtfd'><a class='gjs-link' id='icfyb' href='#feature-section'>About</a><a
              class='gjs-link' href='#feature-section' id='infmy1'>Features</a></div>
          <div class='gjs-grid-column' id='icyzp'><a class='gjs-link' id='i88iz'
              href='#testimonial-section'>Testimonials</a></div>
        </div>
      </div>
      <div class='gjs-grid-column' id='id7x'><a class='gjs-button' id='i1mew'>Join Waitlist</a></div>
    </div>
  </div>
</div>
<div class='gjs-grid-row' id='irz7b'>
  <div class='gjs-grid-column' id='iycz3'>
    <h1 class='gjs-heading' id='irjua'>Insert Hero <span id='i4jn1p' class='gjs-text-blue'>text here</span></h1>
    <div id='itndw' class='text-main-content'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
      tempor incididunt ut labore et dolore magna aliqua.<br/></div><a class='gjs-button' id='iar3s'>Join
...
<div class='gjs-grid-row' id='feature-section'>
  <div class='gjs-grid-column' id='imymf'>
    <div class='gjs-grid-row' id='ib541'>
      <div class='gjs-grid-column' id='iz8m8'>
        <h4 class='gjs-heading gjs-text-blue' id='ij2gh'>Feature One text</h4>
        <h2 class='gjs-heading' id='ism014'>Feature Text</h2>
        <div id='igrx8' class='text-main-content'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua.</div><a class='gjs-button' id='iqx3z1'>Getting
          Started</a>
      </div>
      <div class='gjs-grid-column' id='iepks'><img src='https://images.pexels.com/photos/2121640/pexels-photo-2121640.jpeg?auto=compress&cs=tinysrgb&w=500&dpr=2' id='i466d'/>
      </div>
    </div>
  </div>
</div>
<div class='gjs-grid-row' id='ioyxg'>
  <div class='gjs-grid-column' id='i8w4i'>
    <h4 class='gjs-heading gjs-text-blue' id='ihs4lb'>More Features</h4>
    <h2 class='gjs-heading' id='iiacm'>Put here the text describing why your features are
    ...
    <div class='gjs-grid-row' id='ixzh1'>
      <div class='gjs-grid-column feature-item' id='ilpi3'>
        <div class='gjs-icon gjs-feature-icon' data-type-icon='' id='ipmqo6'><svg viewBox='0 0 24 24'>
            <path
              d='M16 9h3l-5 7m-4-7h4l-2 8M5 9h3l2 7m5-12h2l2 3h-3m-5-3h2l1 3h-4M7 4h2L8 7H5m1-5L2 8l10 14L22 8l-4-6H6z'>
            </path>
          </svg></div>
        <h3 class='gjs-heading' id='in9ef'>Feature text</h3>
      ...
      <div class='gjs-grid-column feature-item' id='ic57kq'>
        <div class='gjs-icon gjs-feature-icon' data-type-icon='' id='ibdusm'><svg viewBox='0 0 24 24'>
            <path
              d='M16 9h3l-5 7m-4-7h4l-2 8M5 9h3l2 7m5-12h2l2 3h-3m-5-3h2l1 3h-4M7 4h2L8 7H5m1-5L2 8l10 14L22 8l-4-6H6z'>
            </path>
          </svg></div>
        <h3 class='gjs-heading' id='ica43q'>Feature text</h3>
        <div id='ickn3f' class='text-main-content'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua.</div>
      </div>
      <div class='gjs-grid-column feature-item' id='idv32l'>
        <div class='gjs-icon gjs-feature-icon' data-type-icon='' id='ipmept'><svg viewBox='0 0 24 24'>
            <path
              d='M16 9h3l-5 7m-4-7h4l-2 8M5 9h3l2 7m5-12h2l2 3h-3m-5-3h2l1 3h-4M7 4h2L8 7H5m1-5L2 8l10 14L22 8l-4-6H6z'>
            </path>
          </svg></div>
        <h3 class='gjs-heading' id='ieu6p6'>Feature text</h3>
...
<div class='gjs-grid-row' id='testimonial-section'>
  <div class='gjs-grid-column' id='infwen'>
    <h2 class='gjs-heading' id='ihap8q'>Testimonial section</h2>
    <div id='i6fjjy' class='text-main-content'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
      tempor incididunt ut labore et dolore magna aliqua.</div>
    <div class='gjs-grid-row' id='i5k4nf'>
      <div class='gjs-grid-column testimonial-item' id='inea73'>
        <div class='gjs-grid-row' id='i2d7qp'>
          <div class='gjs-grid-column' id='idva29'><img src='https://source.unsplash.com/random/200x200/?profile,person,business' id='ia7pcr'/>
          </div>
          <div class='gjs-grid-column' id='i4djop'>
            <h4 class='gjs-heading' id='iqroa4'>Full name</h4>
      ...
      <div class='gjs-grid-column testimonial-item' id='idndjn'>
        <div class='gjs-grid-row' id='ish0zj'>
          <div class='gjs-grid-column' id='inucqu'><img src='https://source.unsplash.com/random/200x200/?profile,person,business' id='ixzdlj'/>
          </div>
          <div class='gjs-grid-column' id='iuk8ib'>
            <h4 class='gjs-heading' id='i04ztt'>Full name</h4>
...
<div class='gjs-grid-row' id='iz29ek'>
  <div class='gjs-grid-column' id='ik2rdi'>
    <h2 class='gjs-heading' id='i83vu9'>Put here your description <br/>for
    ...
    <div id='in201n' class='text-main-content'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
      tempor incididunt ut labore et dolore magna aliqua.<br/></div><a class='gjs-button' id='iwgwt5'>Join
      Waitlist</a>
  </div>
</div>
<div class='gjs-grid-row' id='iv3be5'>
  <div class='gjs-grid-column' id='ilriti'>
    <div class='gjs-grid-row' id='im0rle'>
      <div class='gjs-grid-column' id='iotp6j'><a class='gjs-link-box' href='/public' id='iih6cv'>
          <div class='gjs-icon' data-type-icon='' id='ip6zoj'><svg viewBox='0 0 202 40' fill='none'>
              <path fill-rule='evenodd' clip-rule='evenodd'
                d='M25.5557 11.6853C23.9112 10.5865 21.9778 10 20 10V0C23.9556 0 27.8224 1.17298 31.1114 3.37061C34.4004 5.56823 36.9638 8.69181 38.4776 12.3463C39.9913 16.0008 40.3874 20.0222 39.6157 23.9018C38.844 27.7814 36.9392 31.3451 34.1421 34.1421C31.3451 36.9392 27.7814 38.844 23.9018 39.6157C20.0222 40.3874 16.0008 39.9913 12.3463 38.4776C8.6918 36.9638 5.56823 34.4004 3.37061 31.1114C1.17298 27.8224 0 23.9556 0 20H10C10 21.9778 10.5865 23.9112 11.6853 25.5557C12.7841 27.2002 14.3459 28.4819 16.1732 29.2388C18.0004 29.9957 20.0111 30.1937 21.9509 29.8078C23.8907 29.422 25.6725 28.4696 27.0711 27.0711C28.4696 25.6725 29.422 23.8907 29.8078 21.9509C30.1937 20.0111 29.9957 18.0004 29.2388 16.1732C28.4819 14.3459 27.2002 12.7841 25.5557 11.6853Z'
                fill='#007DFC' class='ccustom'></path>
              <path fill-rule='evenodd' clip-rule='evenodd'
      ...
      <div class='gjs-grid-column' id='i1hx7l'><a class='gjs-link' id='ij7g8t' title='' href='##'>Pricing<br/></a><a
          class='gjs-link' id='ipjdtn' href='##'>Terms &amp; Conditions<br/></a><a class='gjs-link' id='ikj01e'
          href='##'>Refund Policy<br/></a><a class='gjs-link' id='i2sl68' href='##'>Contact Us<br/></a></div>
    </div>

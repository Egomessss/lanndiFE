...
const CreateSiteModal = () => {
    ...
    const formSchema = z.object({
        email: z.string().min(4, 'Name must have at least 4 letters').max(100, { message: 'Must be 100 or fewer characters long' }),
        password: z.string().min(4, 'Name must have at least 4 letters').max(63, { message: 'Must be 63 or fewer characters long' }),
    })
